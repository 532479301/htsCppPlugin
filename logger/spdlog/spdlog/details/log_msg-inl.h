...
namespace spdlog {
namespace details {
SPDLOG_INLINE thread_local char log_msg::thread_name[128]{0};   // for log thread name. Added by Xu Xiang
...
SPDLOG_INLINE log_msg::log_msg(spdlog::log_clock::time_point log_time,
    ...
    : logger_name(a_logger_name),
      ...
      log_thread_name(thread_name)     // for log thread name. Added by Xu Xiang
#endif
      ,
      source(loc),
      payload(msg) {
